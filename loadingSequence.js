...
(function () {
    ...
    // --- Scene 6: Fade into portfolio ---
    // Instead of exploding, we gently zoom the camera in so the text scales up
    // to match the hero section, and simultaneously crossfade the canvas out.
