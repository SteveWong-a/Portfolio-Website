...
# I will write a completely new page.js to make this cleaner and correctly integrate everything.
        ...
        <section id="contact" className="pt-24 mt-20 border-t border-card-border/50">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-12 text-center scroll-reveal hover:shadow-[0_0_40px_rgba(88,166,255,0.2)] transition-shadow duration-500 relative overflow-hidden">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-8">
                    ...
                    <a href="tel:9257337330" className="bg-white/10 border border-white/10 text-white px-6 py-3 rounded-full font-medium hover:bg-white/20 transition-colors inline-flex items-center gap-2">
                        <i className="fa-solid fa-phone"></i> (925) 733-7330
                    </a>
                </div>
